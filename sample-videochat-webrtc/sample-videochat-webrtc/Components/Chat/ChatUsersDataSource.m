...
@interface ChatUsersDataSource()
@property (nonatomic, strong) NSArray *colors;
@property (nonatomic, copy) NSArray *customUsers;
@end

@implementation ChatUsersDataSource
...
- (SelectUserTableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	SelectUserTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SelectUserTableViewCell" forIndexPath:indexPath];
